...
import products, { categories, getAllLocations } from '@/lib/products';
  ...
  return (
    <main>
      ...
      <PageHero
        ...
        subtitle="Browse our carefully selected range of premium products available across Qatar, Dubai, UAE & Saudi Arabia"
      />
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          {filtered.length === 0 ? (
            <div className="text-center py-20">
              ...
              <h3 className="text-xl font-bold text-[#0a1f12] mb-2">No Products Found</h3>
              <p className="text-gray-500 mb-6">
                {searchQuery
                  ? `No products match "${searchQuery}". Try a different search term or clear the filters.`
                  : 'No products in this category and location. Try adjusting your filters.'}
              </p>
              <button
                onClick={() => {
                ...
                className="inline-block bg-[#1a472a] text-white font-medium px-6 py-3 rounded-full hover:bg-[#143722] transition-colors cursor-pointer whitespace-nowrap"
              >
                Clear All Filters
              </button>
            </div>
