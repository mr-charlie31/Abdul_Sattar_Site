...
export default function ProductPage({ params }: { params: { id: string } }) {
    ...
    return (
      <main>
        ...
        <div className="bg-white py-40 text-center">
          ...
          <h1 className="text-2xl font-bold text-[#0a1f12] mb-2">Product Not Found</h1>
          <p className="text-gray-500 mb-6">The product you&apos;re looking for doesn&apos;t exist or has been removed.</p>
          <a href="/shop" className="inline-block bg-[#1a472a] text-white font-medium px-6 py-3 rounded-lg hover:bg-[#143722] transition-colors whitespace-nowrap">
            Back to Shop
          </a>
        </div>
        <SiteFooter />
  ...
  return (
    <div>
      ...
      />
      <ProductDetail product={product} relatedProducts={getRelatedProducts(params.id)} />
      <SiteFooter />
    </div>
  );
}